...
const seedDB = async () => {
    ...
    for(let i=0;i<50;i++){
        ...
        const camp = new Campground({
            ...
            price,
            geometry:{
                "type":"Point","coordinates":[-153.180996665583,64.6358675746]},
            ...
            images: [
                {
                  ...
                  {
                    url: 'https://res.cloudinary.com/raghavmaskara/image/upload/v1645519069/YelpCamp/ue68qbxuqzckenqfaevp.jpg',
